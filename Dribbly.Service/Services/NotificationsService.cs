    ...
    public class NotificationsService : BaseEntityService<NotificationModel>, INotificationsService
    {
        ...
        private async Task<IEnumerable<object>> GetDetailedNotificationsAsync(IEnumerable<NotificationModel> notifications)
        {
            ...
            var genericNotifications = notifications.Where(n =>
            {
                ...
                n.Type == NotificationTypeEnum.JoinedEvent ||
                n.Type == NotificationTypeEnum.JoinEventRequest ||
                n.Type == NotificationTypeEnum.JoinEventRequestApproved ||
                n.Type == NotificationTypeEnum.JoinGroupRequest ||
                n.Type == NotificationTypeEnum.JoinGroupRequestApproved ||
                n.Type == NotificationTypeEnum.PostReceivedReaction;
            });
